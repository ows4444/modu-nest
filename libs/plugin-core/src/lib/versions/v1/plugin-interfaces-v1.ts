 ...
 */
export function createLegacyPluginManifest(manifest: Omit<LegacyPluginManifest, keyof VersionedInterface>): LegacyPluginManifest {
 ...
 */
export function createLegacyPluginMetadata(metadata: Omit<LegacyPluginMetadata, keyof VersionedInterface>): LegacyPluginMetadata {
