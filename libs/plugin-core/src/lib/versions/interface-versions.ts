 ...
 */
export const DEPRECATED_API_VERSIONS = [
...
export const INTERFACE_CHANGELOG = {
  [PluginAPIVersion.V1_0]: {
    released: '2024-01-01',
    changes: [
      'Initial plugin interface definitions',
...
export function areVersionsCompatible(version1: string, version2: string): boolean {
  ...
  return compat1.compatibleWith.includes(version2 as PluginAPIVersion) ||
 ...
 */
export function isInterfaceVersion<T extends VersionedInterface>(
  obj: T,
