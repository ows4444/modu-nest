 ...
 */
export function isValidPluginManifest(value: unknown): value is import('../manifest/plugin-manifest.types').PluginManifest {
  ...
  if (manifest.dependencies && (!Array.isArray(manifest.dependencies) || 
      !manifest.dependencies.every((dep: unknown) => typeof dep === 'string'))) {
    return false;
  }
 ...
 */
export function isValidPluginMetadata(value: unknown): value is import('../manifest/plugin-manifest.types').PluginMetadata {
  ...
  return isValidTimestamp(metadata.uploadedAt) &&
 ...
 */
export function isValidPluginCompatibility(value: unknown): value is import('../manifest/plugin-manifest.types').PluginCompatibility {
  if (!value || typeof value !== 'object') {
    return false;
  }
 ...
 */
export function isValidServiceConfig(value: unknown): value is import('../security/plugin-security.types').CrossPluginServiceConfig {
  if (!value || typeof value !== 'object') {
    return false;
  }
 ...
 */
export function assertPluginManifest(value: unknown): asserts value is import('../manifest/plugin-manifest.types').PluginManifest {
  if (!isValidPluginManifest(value)) {
 ...
 */
export function assertPluginMetadata(value: unknown): asserts value is import('../manifest/plugin-manifest.types').PluginMetadata {
...
export function isValidPluginNameArray(value: unknown): value is PluginName[] {
  return Array.isArray(value) && value.every(item => 
    typeof item === 'string' && isValidPluginName(item)
  );
}
