  ...
  async createContext(
    ...
    if (!this.isVersionSupported(version)) {
      throw new StableContextError(
        ...
        'UNSUPPORTED_VERSION',
        { pluginName, version, supportedVersions: this.SUPPORTED_STABLE_VERSIONS }
      );
    }
    ...
    const stableContext = this.wrapWithStableAPI(
      pluginName,
      version,
      underlyingContext,
      options
    ...
    return {
      async read(path: string): Promise<Buffer> {
        try {
          ...
          throw new StableContextError(
            ...
            'FILE_READ_ERROR',
            { pluginName, path, error: errorMessage }
          );
        }
      },
      ...
      async write(path: string, data: string | Buffer): Promise<void> {
        try {
          ...
          throw new StableContextError(
            ...
            'FILE_WRITE_ERROR',
            { pluginName, path, error: error.message }
          );
        }
      },
      ...
      async list(directory: string): Promise<string[]> {
        try {
          ...
          throw new StableContextError(
            ...
            'FILE_LIST_ERROR',
            { pluginName, directory, error: error.message }
          );
        }
      },
      ...
      async stats(path: string): Promise<any> {
        try {
          ...
          throw new StableContextError(
            `File stats failed: ${error.message}`,
            'FILE_STATS_ERROR',
            { pluginName, path, error: error.message }
          );
        }
    ...
    return {
      async get(url: string, options: any = {}): Promise<any> {
        try {
          ...
          throw new StableContextError(
            `Network GET failed: ${error.message}`,
            'NETWORK_ERROR',
            { pluginName, url, method: 'GET', error: error.message }
          );
        }
      },
      ...
      async post(url: string, body?: any, options: any = {}): Promise<any> {
        try {
          ...
          throw new StableContextError(
            `Network POST failed: ${error.message}`,
            'NETWORK_ERROR',
            { pluginName, url, method: 'POST', error: error.message }
          );
        }
      },
      ...
      async put(url: string, body?: any, options: any = {}): Promise<any> {
        try {
          ...
          throw new StableContextError(
            `Network PUT failed: ${error.message}`,
            'NETWORK_ERROR',
            { pluginName, url, method: 'PUT', error: error.message }
          );
        }
      },
      ...
      async delete(url: string, options: any = {}): Promise<any> {
        try {
          ...
          throw new StableContextError(
            `Network DELETE failed: ${error.message}`,
            'NETWORK_ERROR',
            { pluginName, url, method: 'DELETE', error: error.message }
          );
        }
      },
      ...
      async request(request: any): Promise<any> {
        try {
          ...
          throw new StableContextError(
            ...
            'NETWORK_ERROR',
            { pluginName, request: request.url, method: request.method, error: error.message }
          );
        }
      },
    };
      ...
      async query(sql: string, params?: unknown[]): Promise<any> {
        try {
          ...
          throw new StableContextError(
            ...
            'DATABASE_ERROR',
            { pluginName, sql: sql.substring(0, 100), error: error.message }
          );
        }
      },
      ...
      async select(table: string, where?: string | object, params?: unknown[]): Promise<any> {
        try {
          ...
          throw new StableContextError(
            ...
            'DATABASE_ERROR',
            { pluginName, table, where, error: error.message }
          );
        }
      },
      ...
      async insert(table: string, data: object): Promise<any> {
        try {
          ...
          throw new StableContextError(
            ...
            'DATABASE_ERROR',
            { pluginName, table, error: error.message }
          );
        }
      },
      ...
      async transaction(): Promise<any> {
        try {
          ...
          throw new StableContextError(
            ...
            'DATABASE_ERROR',
            { pluginName, operation: 'transaction', error: error.message }
          );
        }
      },
    };
    ...
    return {
      async getMetrics(): Promise<StableMetrics> {
        try {
          ...
          throw new StableContextError(
            `Metrics retrieval failed: ${error.message}`,
            'METRICS_ERROR',
      ...
      async resetMetrics(): Promise<void> {
        try {
          ...
          throw new StableContextError(
            `Metrics reset failed: ${error.message}`,
            'METRICS_ERROR',
            { pluginName, error: error.message }
          );
        }
