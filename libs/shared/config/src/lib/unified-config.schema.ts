...
export const unifiedConfigSchema = Joi.object({
  ...
  PLUGIN_LOADING_STRATEGY: Joi.string()
    .valid('auto', 'sequential', 'parallel', 'batch')
    .default('auto'),
  ...
  PLUGIN_MEMORY_TRACKING_MODE: Joi.string()
    .valid('minimal', 'selective', 'comprehensive')
    .default('selective'),
  ...
  BUNDLE_OPT_COMPRESSION: Joi.string()
    .valid('gzip', 'brotli', 'deflate')
    .default('gzip'),
