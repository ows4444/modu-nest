...
export class PluginTrustManager {
  ...
  private initializeCapabilities(): void {
    const capabilities: PluginCapability[] = [
      ...
      { name: 'process-env', description: 'Access environment variables', riskLevel: 'medium', category: 'process' },
      { name: 'process-exit', description: 'Exit the host process', riskLevel: 'critical', category: 'process' },
      ...
      { name: 'api-system-info', description: 'Access system information', riskLevel: 'low', category: 'api' },
